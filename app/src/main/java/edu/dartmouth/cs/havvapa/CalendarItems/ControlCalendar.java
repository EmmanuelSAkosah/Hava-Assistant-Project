...
class ControlCalendar {
    ...
    ControlCalendar(Paint dayPaint, OverScroller scroller, Rect textSizeRect, AttributeSet attrs,
    ...
    void setUseWeekDayAbbreviation(boolean useThreeLetterAbbreviation) {
        ...
        this.dayColumnNames = WeekViewHelper.getWeekdayNames(locale, firstDayOfWeekToDraw, this.useThreeLetterAbbreviation);
    }
