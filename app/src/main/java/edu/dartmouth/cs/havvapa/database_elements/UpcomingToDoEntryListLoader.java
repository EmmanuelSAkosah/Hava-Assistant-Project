...
public class UpcomingToDoEntryListLoader extends AsyncTaskLoader<ArrayList<ToDoEntry>>
{

    private ToDoItemsSource datasource;

    public UpcomingToDoEntryListLoader(@NonNull Context context)
    {
        super(context);
    ...
    {
        try{
            return datasource.getAllUpcomingEntries();
        }
        catch (Exception e){
